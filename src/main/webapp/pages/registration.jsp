...
<body>
<c:set var="pagePath" value="/pages/registration.jsp" scope="session"/>
        ...
        <fieldset>
            ...
            <div>
                ...
                <div class="form-group col-md-4">
                    <input class="form-control" type="text" name="login" value="${fn:escapeXml(map.login)}"
                           required
            ...
            <div>
                <label class="col-md-4 control-label"><fmt:message key="registration.patronymic"/> <span
                        class="text-danger">*</span></label>
                <div class="form-group col-md-4">
                    <input class="form-control" type="text" name="patronymic" value="${fn:escapeXml(map.patronymic)}"
                           required
                           maxlength="45"
                           minlength="1"
            ...
            <strong><p class="text-danger"> ${map.incorrectPatronymic} </p></strong>
            <div>
                <label class="col-md-4 control-label"><fmt:message key="registration.email"/> <span
                        class="text-danger">*</span></label>
                <div class="form-group col-md-4">
                    <input class="form-control" type="email" name="email" value="${fn:escapeXml(map.email)}"
                           required
                           maxlength="45"
                           minlength="1"
            ...
            <strong><p class="text-danger"> ${map.incorrectEmail} </p></strong>
        </fieldset>
